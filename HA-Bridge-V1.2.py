    ...
    def loop(self):
        ...
        while self.master.is_running:
            ...
            try:
                ...
                try:
                    response_dc = requests.get(f"{dc_url_full}?{current_bg} {time.time()}", timeout=120)
                    ...
                    # Ignore normal long-polling timeouts
                    continue
                ...
                if new_hex and new_hex != current_bg:
                    ...
                    try:
                        res_ha = requests.post(ha_url_full, json=payload, headers=headers_ha, timeout=60)
